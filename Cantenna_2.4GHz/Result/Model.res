...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Power\Excitation [1]\Loss per Material\Metal loss in Copper (pure)
files=s:cMetal_loss_Copper (pure)(1).sig
...
lifetime=s:rebuild
result=s:1
treepath=s:1D Results\Power\Excitation [1]\Loss per Material\Volume loss in PTFE (lossy)
files=s:cVolume_loss_in_PTFE (lossy)(1).sig
